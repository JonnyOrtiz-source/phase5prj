...
Service.create(name: "Swedish Massage, 60 min", description: "Relaxes the body and relieves pain in muscles with slow calming strokes.", price: 80, image_url: "https://serenity-springs-assets.s3.amazonaws.com/swedishMassage.jpg", service_type_id: 4, duration_id: 10)
Service.create(name: "Chair Massage, 15 min", description: "Done while sitting using compression to relieve tension.", price: 20, image_url: "https://serenity-springs-assets.s3.amazonaws.com/chairMassage.jpg", service_type_id: 4, duration_id: 7)
Service.create(name: "Chair Massage, 30 min", description: "Done while sitting using compression to relieve tension.", price: 35, image_url: "https://serenity-springs-assets.s3.amazonaws.com/chairMassage.jpg", service_type_id: 4, duration_id: 8)
